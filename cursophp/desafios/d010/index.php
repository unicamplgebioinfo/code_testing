  ...
  <body>
    ...
    <main>
      ...
      <form action="<?=$_SERVER['PHP_SELF']?>" method="get">
        ...
        <input type="number" id="idv1" name="v1" value="<?=$ano?>" required>
        <label for="v2">Quer saber sua idade em que ano? (atualmente estamos em <b><?=$anoHoje?></b>):</label>
        <input type="number" id="idv2" name="v2" value="<?=$anoAtual?>" required>
